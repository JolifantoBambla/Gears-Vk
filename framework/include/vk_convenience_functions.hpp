...
namespace gvk
{
  inline vk::Format default_rgb8_4comp_format() noexcept { return vk::Format::eR8G8B8A8Unorm; }
  inline vk::Format default_rgb8_3comp_format() noexcept { return vk::Format::eR8G8B8Unorm; }
  inline vk::Format default_rgb8_2comp_format() noexcept { return vk::Format::eR8G8Unorm; }
  inline vk::Format default_rgb8_1comp_format() noexcept { return vk::Format::eR8Unorm; }
  inline vk::Format default_srgb_4comp_format() noexcept { return vk::Format::eR8G8B8A8Srgb; }
  inline vk::Format default_srgb_3comp_format() noexcept { return vk::Format::eR8G8B8Srgb; }
  inline vk::Format default_srgb_2comp_format() noexcept { return vk::Format::eR8G8Srgb; }
  inline vk::Format default_srgb_1comp_format() noexcept { return vk::Format::eR8Srgb; }
  inline vk::Format default_rgb16f_4comp_format() noexcept { return vk::Format::eR16G16B16A16Sfloat; }
  inline vk::Format default_rgb16f_3comp_format() noexcept { return vk::Format::eR16G16B16Sfloat; }
  inline vk::Format default_rgb16f_2comp_format() noexcept { return vk::Format::eR16G16Sfloat; }
  inline vk::Format default_rgb16f_1comp_format() noexcept { return vk::Format::eR16Sfloat; }
